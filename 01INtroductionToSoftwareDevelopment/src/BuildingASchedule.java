...
public class BuildingASchedule {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Please enter only values 1-7\n");
        ...
        switch (dayOfTheWeek) {
            ...
            case 2:
                System.out.println("Tuesday is coding time");
                break;
            ...
            case 5:
                System.out.println("Friday: Run tests and check if the program is working");
                break;
    ...
    /**
     * Displays the Monday submenu and processes the user's choice.
     *
     * @param keyboard Scanner object used for user input
     */
    public static void mondayMenu(Scanner keyboard) {
